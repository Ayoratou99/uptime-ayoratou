...
class Database {
    ...
    static async patch(port = undefined, hostname = undefined) {
        // Still need to keep this for old versions of Ayoratou
        ...
        try {
            ...
            if (e.message.includes("the following files are missing:")) {
                ...
                log.warn("db", "Database migration failed, you may be downgrading Ayoratou.");
            } else {
    ...
    static async patchSqlite() {
        ...
        if (version === this.latestVersion) {
            ...
            try {
                ...
                log.error("db", ex);
                log.error("db", "Start Ayoratou failed due to issue patching the database");
                log.error(
                    "db",
